...
async function main() {
  for (const [contractName, metadataHashes] of Object.entries(contractMetadataHashes)) {
    ...
    const overwrittenArtifact = metadataHashes.reduce((acc, { oldMetadataHash, newMetadataHash }) => {
