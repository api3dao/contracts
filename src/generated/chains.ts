...
export const CHAINS: Chain[] = [
  ...
  },
  {
    ...
    id: '1',
    name: 'Ethereum',
    providers: [{ alias: 'default', rpcUrl: 'https://ethereum-rpc.publicnode.com' }],
    symbol: 'ETH',
    testnet: false,
    verificationApi: { type: 'etherscan' },
  },
  ...
  },
  {
    ...
    id: '1776',
    name: 'Injective EVM',
    providers: [{ alias: 'default', rpcUrl: 'https://sentry.evm-rpc.injective.network' }],
    symbol: 'INJ',
    testnet: false,
  ...
  },
  {
    ...
    id: '747474',
    name: 'Katana',
    providers: [{ alias: 'default', rpcUrl: 'https://rpc.katana.network' }],
    symbol: 'ETH',
    testnet: false,
    verificationApi: { type: 'etherscan' },
  },
  ...
  },
  {
    ...
    id: '137',
    name: 'Polygon',
    providers: [{ alias: 'default', rpcUrl: 'https://polygon-bor-rpc.publicnode.com' }],
    symbol: 'POL',
    testnet: false,
    verificationApi: { type: 'etherscan' },
  },
  ...
  },
  {
    ...
    id: '167000',
    name: 'Taiko',
    providers: [{ alias: 'default', rpcUrl: 'https://rpc.mainnet.taiko.xyz' }],
    symbol: 'ETH',
    testnet: false,
    verificationApi: { type: 'etherscan' },
  },
