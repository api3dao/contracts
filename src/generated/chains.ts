...
export const CHAINS: Chain[] = [
  ...
  {
    alias: 'filecoin-testnet',
    blockExplorerUrl: 'https://filecoin-testnet.blockscout.com',
    decimals: 18,
    id: '314159',
    name: 'Filecoin testnet',
    providers: [{ alias: 'default', rpcUrl: 'https://api.calibration.node.glif.io/rpc/v1' }],
    symbol: 'FIL',
    testnet: true,
    verificationApi: { type: 'blockscout', url: 'https://filecoin-testnet.blockscout.com/api' },
  },
  {
    alias: 'filecoin',
    ...
    name: 'Filecoin',
    providers: [
      { alias: 'default', rpcUrl: 'https://api.node.glif.io/rpc/v1' },
  ...
  {
    alias: 'robinhood-sepolia-testnet',
    blockExplorerUrl: 'https://explorer.testnet.chain.robinhood.com/',
    decimals: 18,
    id: '46630',
    name: 'Robinhood Chain testnet',
    providers: [{ alias: 'default', rpcUrl: 'https://rpc.testnet.chain.robinhood.com' }],
    symbol: 'ETH',
    testnet: true,
    verificationApi: { type: 'blockscout', url: 'https://explorer.testnet.chain.robinhood.com/api' },
  },
  {
    alias: 'robinhood',
    ...
    providers: [
      { alias: 'default', rpcUrl: 'https://rpc.mainnet.chain.robinhood.com' },
      { alias: 'alchemy', homepageUrl: 'https://alchemy.com' },
      { alias: 'quicknode', homepageUrl: 'https://quicknode.com' },
      { alias: 'reblok', homepageUrl: 'https://reblok.io' },
    ],
  ...
  },
  {
    ...
    providers: [{ alias: 'default', rpcUrl: 'https://rpc.garfield-testnet.zircuit.com' }],
    symbol: 'ETH',
    testnet: true,
    verificationApi: { type: 'sourcify' },
  },
